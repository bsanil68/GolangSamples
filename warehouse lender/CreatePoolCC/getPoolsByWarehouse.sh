...
echo "WarehouseLenderName is " $1
WarehouseLenderName=$1

var=$(peer chaincode query -C composerchannelrest -n WarehouseCreatepoolCC -v 1 -c '{"Args":["GetPoolsByWarehouseLenderName","'"$WarehouseLenderName"'"]}')
