...
echo "LoanDocumentHash:" ${29}
LoanDocumentHash=${29}

echo "WarehouseLenderName:" ${30}
WarehouseLenderName=${30}


peer chaincode invoke -o orderer0:7050  --tls --cafile /root/bcnetwork/conf/crypto-config/ordererOrganizations/ordererorg0/orderers/orderer0.ordererorg0/msp/tlscacerts/tlsca.ordererorg0-cert.pem -C composerchannelrest -n WarehouseLoansCC -c '{"Args":["CreateLoans","'"$LoanID"'","'"$LoanContractNumber"'","'"$City"'","'"$DateOfLoanAgreement"'","'"$Lender"'","'"$DateOfLoanApplication"'","'"$SignedAndDeliveredBy"'","'"$TypeOfLoan"'","'"$LoanPurpose"'","'"$LoanOrFacilityAmount"'","'"$LoanOrFacilityTermInMonths"'","'"$InterestType"'","'"$InterestChargeablePerAnnum"'","'"$DefaultInterestRatePerAnnum"'","'"$ModeOfCommunicationForInterestRateChange"'","'"$ApplicationProcessingFee"'","'"$OtherConditions"'","'"$EmiPayable"'","'"$LastEMIPayable"'","'"$DateOfCommencementOfEMI"'","'"$ModeOfRepayment"'","'"$InsurancePremium"'","'"$CalculatedLTV"'","'"$State"'","'"$OverdueAgeing"'","'"$DefaultRating"'","'"$Currency"'","'"$LoanHash"'","'"$LoanDocumentHash"'","'"$WarehouseLenderName"'"]}'
