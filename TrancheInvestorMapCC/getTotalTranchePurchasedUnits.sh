...
var=$(peer chaincode query -C composerchannelrest -n TrancheInvestorMap1CC -c '{"Args":["GetTotalNumOfUnitsPurchasedOfTranche","'"$trancheID"'"]}')
echo $var | sed -e 's/Query\ Result\:\ \[//g' -e 's/\]//g' >> noOfUnitsPurchasedOfTranche.json
