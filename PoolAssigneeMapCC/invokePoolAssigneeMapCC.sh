...
echo "approv_status:" $6
approv_status=$6

peer chaincode invoke -o orderer0:7050  --tls --cafile /root/bcnetwork/conf/crypto-config/ordererOrganizations/ordererorg0/orderers/orderer0.ordererorg0/msp/tlscacerts/tlsca.ordererorg0-cert.pem -C composerchannelrest -n PoolAssigneeMapCCode --version 1.4 -c '{"Args":["SavePoolAssigneeMap","'"$PoolID"'","'"$assignee_id"'","'"$approv_date"'","'"$approv_type"'","'"$approv_id"'","'"$approv_status"'"]}'
