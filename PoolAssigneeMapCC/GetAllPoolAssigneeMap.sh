...
var=$(peer chaincode query -C composerchannelrest -n PoolAssigneeMCCode --version 1.0.1  -c '{"Args":["GetAllPoolAssigneeMaps"]}')

echo $var | sed -e 's/Query\ Result\://g' >> AllassigneeDetails.json 
