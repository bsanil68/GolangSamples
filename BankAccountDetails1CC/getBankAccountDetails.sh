...
var=$(peer chaincode query -C composerchannelrest -n BankAccountDetails1CC -c '{"Args":["GetBankAccountDetails","'"$userID"'"]}')
echo $var | sed -e 's/Query\ Result\://g'>>getBankAccountDetails.json
