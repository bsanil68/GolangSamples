...
echo "PoolAttributeID:" $1
PoolAttributeID=$1

echo "PoolAttibuteName:" $2
PoolAttributeName=$2

echo "PoolAttributeValue:" $3
PoolAttributeValue=$3

peer chaincode invoke -o orderer0:7050  --tls --cafile /root/bcnetwork/conf/crypto-config/ordererOrganizations/ordererorg0/orderers/orderer0.ordererorg0/msp/tlscacerts/tlsca.ordererorg0-cert.pem -C composerchannelrest -n CreatePoolAttributeCC -c '{"Args":["CreatePoolAttrs","'"$PoolAttributeID"'","'"$PoolAttributeName"'","'"$PoolAttributeValue"'"]}'

#peer chaincode invoke -o orderer0:7050  --tls --cafile /root/bcnetwork/conf/crypto-config/ordererOrganizations/ordererorg0/orderers/orderer0.ordererorg0/msp/tlscacerts/tlsca.ordererorg0-cert.pem -C composerchannelrest -n CreatePoolAttributeCC -c '{"Args":["CreatePoolAttrs","001","bankofindia","boidesc"]}'
