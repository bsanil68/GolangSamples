...
PoolAttributeID=$1
var=$(peer chaincode query -C composerchannelrest -n CreatePoolAttributeCC  -c '{"Args":["GetpoolAttr","'"$PoolAttributeID"'"]}')
echo $var | sed -e 's/Query\ Result\://g' >> PoolAttributeDetails.json
