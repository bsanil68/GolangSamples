...
echo "PoolAttributeID is:" $1
PoolAttributeID=$1
var=$(peer chaincode query -C composerchannelrest -n CreatePoolAttributeCC  -c '{"Args":["GetAllpoolAttrs"]}')
echo $var | sed -e 's/Query\ Result\:\ \[//g' -e 's/\]//g' >> AllPoolAttributes.json
