...
var=$(peer chaincode query -C composerchannelrest -n TransactionDetails6CC -c '{"Args":["GetTransactionDetailsByPayeeId","'"$payeeID"'"]}')
#echo $var | sed -e 's/Query\ Result\:\ \[//g' -e 's/\]//g' >>/home/asrikantiah/json/GetTransactionDetailsByPayeeId.json
