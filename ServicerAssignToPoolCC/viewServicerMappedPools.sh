...
var=$(peer chaincode query -C composerchannelrest -n ServicerAssignToPoolCC  -c '{"Args":["GetPoolsAssignedToServicer","'"$servicerID"'"]}')
echo $var | sed -e 's/Query\ Result\:\ \[//g' -e 's/\]//g' >> servicerPoolMap.json
