...
echo "ApprovalStatus:" $3
ApprovalStatus=$3

echo "ApprovalDate:" $4
ApprovalDate=$4

peer chaincode invoke -o orderer0:7050  --tls --cafile /root/bcnetwork/conf/crypto-config/ordererOrganizations/ordererorg0/orderers/orderer0.ordererorg0/msp/tlscacerts/tlsca.ordererorg0-cert.pem -C composerchannelrest -n ServicerAssignToPool --version 1.5 -c '{"Args":["SaveApproval","'"$PoolID"'","'"$ServicerID"'","'"$ApprovalStatus"'","'"$ApprovalDate"'"]}'
